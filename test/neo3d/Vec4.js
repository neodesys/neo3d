...
{
    assert.equal(Vec4.NB_COMPONENTS, 4);
    assert.bufferEqual(Vec4.I.buffer, [1, 0, 0, 0]);
    assert.bufferEqual(Vec4.J.buffer, [0, 1, 0, 0]);
    assert.bufferEqual(Vec4.K.buffer, [0, 0, 1, 0]);
    assert.bufferEqual(Vec4.L.buffer, [0, 0, 0, 1]);
});

QUnit.test("createBuffer", function(assert)
{
    var buffer = Vec4.createBuffer(2);
    assert.equal(buffer.length, 2 * Vec4.NB_COMPONENTS);
...
{
    var v4 = new Vec4().setFromArray(this.randomVal);
...
{
    var v0 = new Vec4().setFromValues(1.2, 1.6, 3.2, 2.2),
        v1 = new Vec4().setFromValues(0.6, 5.3, 1.6, 7.1);
...
{
    var v4 = new Vec4().setFromValues(0.6, 5.3, 1.6, 7.1);
...
{
    var v0 = new Vec4().setFromValues(2.6, 3.2, 0.6, 5.4),
        v1 = new Vec4().setFromValues(1.4, 2.1, 1.4, 0.1);
...
{
    var v4 = new Vec4().setFromValues(1.4, 2.1, 1.4, 0.1);
...
{
    var v4 = new Vec4().setFromValues(4.5, 1.2, 6.7, 0.6);
...
{
    var v0 = new Vec4().setFromArray(this.randomVal),
        v1 = new Vec4().negate(v0);
...
{
    var v4 = new Vec4().setFromValues(1.8, 2.4, 0.7, 3.6);
...
{
    var v4 = new Vec4().setFromValues(8.6, 4.5, 1.7, 0.9);
...
{
    var v4 = new Vec4().setFromValues(1.5, 0.6, 1.7, 2.2);
...
{
    var p0 = new Vec4().setFromValues(0.2, 4.7, 2.2, 1.4),
        p1 = new Vec4().setFromValues(1.7, -2.8, 2.7, -1.6);
...
{
    var p0 = new Vec4().setFromValues(1.3, -0.4, 2.5, 3.6),
        p1 = new Vec4().setFromValues(2.4, 1.2, 4.7, -0.4),
        p2 = new Vec4().setFromValues(3.5, 0.4, 6.9, 3.9);
...
{
    var t0 = new Vec4().setFromValues(1.5, -0.5, -2.85, 1.75),
        p0 = new Vec4().setFromValues(2.1, 3.2, 4.1, -1.6),
        p1 = new Vec4().setFromValues(4.2, 1.4, -2.6, 3.7),
        t1 = new Vec4().setFromValues(1.55, -0.45, -3.65, 3.05);
...
{
    var ctrl0 = new Vec4().setFromValues(2.6, 3.0333333, 3.15, -1.0166667),
        p0 = new Vec4().setFromValues(2.1, 3.2, 4.1, -1.6),
        p1 = new Vec4().setFromValues(4.2, 1.4, -2.6, 3.7),
        ctrl1 = new Vec4().setFromValues(3.6833333, 1.55, -1.3833333, 2.6833333);
...
{
    var p0 = new Vec4().setFromValues(1.2, 2.4, 3.1, 0.2),
        p1 = new Vec4().setFromValues(2.1, 3.2, 4.1, -1.6),
        p2 = new Vec4().setFromValues(4.2, 1.4, -2.6, 3.7),
        p3 = new Vec4().setFromValues(5.2, 2.3, -3.2, 4.5);
