...
{
	assert.equal(neo3d.Vec2.NB_COMPONENTS, 2);
	assert.bufferEqual(neo3d.Vec2.I.buffer, [1, 0]);
	assert.bufferEqual(neo3d.Vec2.J.buffer, [0, 1]);
});

QUnit.test("createBuffer", function(assert)
{
	var buffer = neo3d.Vec2.createBuffer(2);
	assert.equal(buffer.length, 2 * neo3d.Vec2.NB_COMPONENTS);
...
{
	var v0 = new neo3d.Vec2().setFromValues(1.2, 1.6),
		v1 = new neo3d.Vec2().setFromValues(0.6, 5.3);
...
{
	var v2 = new neo3d.Vec2().setFromValues(0.6, 5.3);
...
{
	var v0 = new neo3d.Vec2().setFromValues(2.6, 3.2),
		v1 = new neo3d.Vec2().setFromValues(1.4, 2.1);
...
{
	var v2 = new neo3d.Vec2().setFromValues(1.4, 2.1);
...
{
	var v2 = new neo3d.Vec2().setFromValues(4.5, 1.2);
...
{
	var v0 = new neo3d.Vec2().setFromArray(this.randomVal),
		v1 = new neo3d.Vec2().negate(v0);
...
{
	var v2 = new neo3d.Vec2().setFromValues(1.8, 2.4);
...
{
	var v2 = new neo3d.Vec2().setFromValues(1.5, 0.6);
...
{
	assert.ok(neo3d.Vec2.I.isPerpendicular(neo3d.Vec2.J));
...
{
	var p0 = new neo3d.Vec2().setFromValues(0.2, 4.7),
		p1 = new neo3d.Vec2().setFromValues(1.7, -2.8);
...
{
	var p0 = new neo3d.Vec2().setFromValues(1.3, -0.4),
		p1 = new neo3d.Vec2().setFromValues(2.4, 1.2),
		p2 = new neo3d.Vec2().setFromValues(3.5, 0.4);
...
{
	var t0 = new neo3d.Vec2().setFromValues(1.5, -0.5),
		p0 = new neo3d.Vec2().setFromValues(2.1, 3.2),
		p1 = new neo3d.Vec2().setFromValues(4.2, 1.4),
		t1 = new neo3d.Vec2().setFromValues(1.55, -0.45);
...
{
	var ctrl0 = new neo3d.Vec2().setFromValues(2.6, 3.0333333),
		p0 = new neo3d.Vec2().setFromValues(2.1, 3.2),
		p1 = new neo3d.Vec2().setFromValues(4.2, 1.4),
		ctrl1 = new neo3d.Vec2().setFromValues(3.6833333, 1.55);
...
{
	var p0 = new neo3d.Vec2().setFromValues(1.2, 2.4),
		p1 = new neo3d.Vec2().setFromValues(2.1, 3.2),
		p2 = new neo3d.Vec2().setFromValues(4.2, 1.4),
		p3 = new neo3d.Vec2().setFromValues(5.2, 2.3);
